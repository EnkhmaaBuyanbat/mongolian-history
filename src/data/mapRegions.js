...
export const mapRegions = [
  ...
  {
    id:'map-region-mongol-imperial-world',name:'Mongol Imperial World',snapshotYears:[1227,1234,1241,1251,1258],polityId:'polity-yeke-mongol-ulus',representation:'POLITICAL_SPHERE',geographicConfidence:'APPROXIMATE',treatment:'INTERPRETED',geometrySource:null,geometryMethod:null,sourceIds:['source-dunnell-rise-chinggis-2023'],summary:'A broad imperial framework connected diverse territories, households, commands and administrative practices without producing uniform control everywhere.',caution:approximateFrontierCaution,
    snapshotProvenance:{1241:{geometrySource:'HISTORICAL_ATLAS',geometryMethod:'SIMPLIFIED_TRACE',sourceIds:['source-cambridge-map-mongol-empire-1241'],caution:'The rendered boundary will be a deliberately simplified educational reconstruction and should not be read as a surveyed medieval frontier.'}},
    // Future reviewed geometry must be GeoJSON Polygon/MultiPolygon coordinates in [longitude, latitude] order.
    geometry:null,
  },
  {
