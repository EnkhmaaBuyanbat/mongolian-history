export const chapters = [
  ...
  },
  {
    ...
    relatedEventIds: ['event-end-uyghur-khaganate-840', 'event-liao-begins-907'], relatedPeopleIds: [], relatedPolityIds: ['polity-uyghur-khaganate', 'polity-khitan-liao'], relatedPlaceIds: ['place-orkhon-valley'], relatedSiteIds: [], relatedObjectIds: [], sourceIds: [],
    sections: [
      ...
      { id: 'khitan-expansion', number: '07', title: 'Toward Khitan Expansion', paragraphs: ['Khitan political power became a major imperial force in the emerging regional order.'], sourceIds: [] },
  ...
  },
  {
    ...
    sections: [
      ...
      {id:'liao-907',number:'02',title:'907 and the Liao',paragraphs:['The year 907 conventionally marks the beginning of Liao imperial rule.'],sourceIds:[]},
      ...
      {id:'liao-evidence',number:'06',title:'How We Know',paragraphs:['A dedicated verified Liao source record is required before this project can provide deeper detail.'],sourceIds:[]},
      {id:'chintolgoi-gap',number:'07',title:'Archaeological Research Gap',paragraphs:['Chintolgoi is omitted because no supported site or source record is currently present.'],evidenceNote:{claim:'A Chintolgoi population-movement case study',sourceBasis:'Dedicated archaeological source record required',evidenceType:'Documentary and archaeological research',treatment:'Omitted pending source metadata',confidence:'ARCHAEOLOGICAL EVIDENCE',caution:'Objects alone would not establish individual ethnic identity.'},sourceIds:[]},
      {id:'toward-1125',number:'08',title:'Toward 1125',paragraphs:['Liao political rule ended in 1125, but Khitan histories continued along multiple trajectories.'],educationalVisual:{title:'Imperial Network, Not Modern Border',variant:'landscape',items:[{title:'Imperial Centre'},{title:'Regional Authority'},{title:'Political Connections'},{title:'Contested Influence'}],note:'This conceptual network does not claim exact territorial control.'},sourceIds:[]},
    ],
  },
  {
  ...
  {
    id:'chapter-temujins-world',eraId:'before-chinggis',number:'05',title:"Temüjin's World",subtitle:'Early Life, Narrative Sources and Political Context',period:'c. 1160s–late 12th century',status:'in-progress',summary:"What can we responsibly reconstruct about Temüjin's early life and political environment?",intro:'Temüjin entered an already organized political world. Much of the detailed early-life narrative depends on medieval traditions for which this project still requires a verified source record.',relatedEventIds:['event-birth-temujin-debated'],relatedPeopleIds:['person-temujin-chinggis-khan','person-borte','person-hoelun','person-yesugei'],relatedPolityIds:['polity-mongol-groupings','polity-merkit'],relatedPlaceIds:[],relatedSiteIds:[],relatedObjectIds:[],sourceIds:[],sections:[
      {id:'world-temujin-entered',number:'01',title:'The World He Entered',paragraphs:['Temüjin entered a world of households, lineages, coalitions and neighbouring powers.'],sourceIds:[]},{id:'family-source-traditions',number:'02',title:'Family and Early Source Traditions',paragraphs:['Yesügei, Hö’elün and Börte belong to the controlled narrative framework, but detailed scenes are omitted without a verified narrative source.'],sourceIds:[]},{id:'borte-merkit',number:'03',title:'Börte and the Merkit Episode',paragraphs:['The broad episode is source-dependent; precise chronology, motives and dialogue are not supplied.'],sourceIds:[]},{id:'jamukha-context',number:'04',title:'Jamukha',paragraphs:['Jamukha had political agency and should not be reduced to a villain in Temüjin’s story.'],sourceIds:[]},{id:'toghrul-context',number:'05',title:'Toghrul / Ong Khan',paragraphs:['Toghrul was a major Kereit ruler, not merely a supporting figure.'],sourceIds:[]},{id:'building-coalition',number:'06',title:'Building a Coalition',paragraphs:['Temüjin’s coalition developed through changing political relationships; dominance was not inevitable.'],sourceIds:[]},{id:'limits-early-life',number:'07',title:'Limits of Reconstruction',paragraphs:['No birth year more exact than the debated c. 1160s range is asserted.'],sourceIds:[]},{id:'account-reconstruction',number:'08',title:'Source Account vs Historical Reconstruction',paragraphs:['Narrative detail and modern reconstruction must remain analytically distinct.'],educationalVisual:{title:'Source Account vs Historical Reconstruction',variant:'comparison',items:[{title:'Source Account',text:'what a medieval narrative reports'},{title:'Historical Reconstruction',text:'claims assessed across evidence and context'}],note:'No dialogue or quotation is fabricated.'},sourceIds:[]},
    ]},
  {
