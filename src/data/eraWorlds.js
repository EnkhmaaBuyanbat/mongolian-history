...
export const eraWorlds = [
  {
    id: 'era-world-ancient-steppe', slug: 'ancient-steppe-world', eraId: 'ancient-steppe', worldType: 'FALLBACK', reconstructionId: null, mediaId: null,
    fallbackStyle: 'ancient-stone', visualStatus: 'PLANNED', evidenceLabel: null,
    ...
    desktopPosition: 'center', mobilePosition: 'center', overlayStrength: 'strong', depthProfile: 'archaeological-landscape', future3dExperienceId: 'experience-xiongnu-elite-tomb', approved: true,
  },
  {
    id: 'era-world-before-chinggis', slug: 'before-chinggis-world', eraId: 'before-chinggis', worldType: 'FALLBACK', reconstructionId: null, mediaId: null,
    fallbackStyle: 'fragmented-steppe', visualStatus: 'PLANNED', evidenceLabel: null,
    ...
    desktopPosition: 'center', mobilePosition: 'center', overlayStrength: 'strong', depthProfile: 'distributed-camps', future3dExperienceId: null, approved: true,
  },
  {
  ...
  {
    id: 'era-world-mongol-world', slug: 'connected-mongol-world', eraId: 'mongol-world', worldType: 'FALLBACK', reconstructionId: null, mediaId: null,
    fallbackStyle: 'connected-world', visualStatus: 'PLANNED', evidenceLabel: null,
    shortDescription: 'A future atmosphere of movement, communication, and regional diversity across the connected Mongol world.',
    ...
    desktopPosition: 'center', mobilePosition: 'center', overlayStrength: 'strong', depthProfile: 'distant-route', future3dExperienceId: 'experience-mongol-relay-network', approved: true,
  },
  {
    id: 'era-world-northern-yuan', slug: 'later-mongol-powers-world', eraId: 'northern-yuan', worldType: 'FALLBACK', reconstructionId: null, mediaId: null,
    fallbackStyle: 'later-steppe', visualStatus: 'PLANNED', evidenceLabel: null,
    shortDescription: 'A future mobile political landscape of fragmentation, rivalry, and renewal after 1368.', historicalBasis: ['Mobile courts', 'Changing coalitions', 'Later medieval steppe material culture'],
    ...
    promptBrief: 'Multiple distant camps and mobile retinues in a broad steppe landscape; do not imply one continuously unified state.', desktopPosition: 'center', mobilePosition: 'center', overlayStrength: 'strong', depthProfile: 'multiple-centers', future3dExperienceId: null, approved: true,
  },
  {
    id: 'era-world-qing-rule', slug: 'qing-mongolia-world', eraId: 'qing-rule', worldType: 'FALLBACK', reconstructionId: null, mediaId: null,
    fallbackStyle: 'monastic-steppe', visualStatus: 'PLANNED', evidenceLabel: null,
    shortDescription: 'A future pastoral, monastic, commercial, and imperial-order environment grounded in Mongolia’s own landscapes.', historicalBasis: ['Pastoral households', 'Monastic institutions', 'Trade and imperial administration'],
    ...
    promptBrief: 'Steppe and sacred architecture with pastoral households and distant movement; avoid reducing Qing Mongolia to Chinese palace imagery.', desktopPosition: 'center', mobilePosition: 'center', overlayStrength: 'strong', depthProfile: 'sacred-landscape', future3dExperienceId: 'experience-qing-monastic-pastoral-world', approved: true,
  },
  {
    id: 'era-world-revolution-socialist', slug: 'revolution-socialist-world', eraId: 'revolution-socialist', worldType: 'FALLBACK', reconstructionId: null, mediaId: null,
    fallbackStyle: 'transforming-city', visualStatus: 'AWAITING_ARCHIVAL_MEDIA', evidenceLabel: null,
    shortDescription: 'A future documentary-led world showing political, urban, pastoral, and social transformation across 1911–1990.', historicalBasis: ['Archival photography', 'Urban and pastoral transformation', 'Public and institutional history'],
