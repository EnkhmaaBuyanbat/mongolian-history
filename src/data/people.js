...
export const people = [
  ...
  { id:'person-temujin-chinggis-khan',slug:'temujin-chinggis-khan',title:'Temüjin / Chinggis Khan',profileType:'story',role:'Leader of an emerging Mongol political order',period:'born c. 1160s (date debated); Era II coverage through 1206',eraId:'before-chinggis',status:'researched',summary:'Temüjin entered a complex political world and became the central leader of the political reorganization recognized in 1206. His later imperial campaigns belong to Era III and are not covered here.',relatedEntityIds:['polity-mongol-groupings','polity-emerging-mongol-order','event-birth-temujin-debated','event-kereit-defeat-1203','event-naiman-defeat-1204','event-new-mongol-order-1206'],sourceRefs:[],biographySections:[{id:'temujin-world',number:'02',title:'The World He Entered',paragraphs:['Temüjin did not create political organization from nothing, and his eventual dominance was not inevitable.']},{id:'temujin-source',number:'03',title:'Family and Early Source Traditions',paragraphs:['Detailed early-life scenes are omitted until a verified medieval narrative source record is available.'],callout:{label:'Source Account',text:'Narrative traditions require critical treatment rather than presentation as eyewitness transcripts.',confidence:'SOURCE ACCOUNT'}},{id:'temujin-coalition',number:'04',title:'Building a Political Coalition',paragraphs:['His coalition developed through changing alliances, rivalries and political realignments.']},{id:'temujin-turning-points',number:'05',title:'1203–1204',paragraphs:['Kereit and Naiman defeats changed political power without making their communities disappear.']},{id:'temujin-1206',number:'06',title:'1206',paragraphs:['An assembly recognized Temüjin as Chinggis Khan within a major political reorganization.']},{id:'temujin-evidence',number:'07',title:'How Do We Know This?',paragraphs:['Dedicated source records are required before detailed narrative episodes can be responsibly presented.']}] },
  { id:'person-borte',slug:'borte',title:'Börte',profileType:'biography',role:'Historical actor in Temüjin’s household and political world',eraId:'before-chinggis',status:'researched',summary:'Börte was a historical actor in Temüjin’s early household and political context. The capture and recovery episode is source-dependent and requires a verified Secret History source record before detailed narration.',relatedEntityIds:['person-temujin-chinggis-khan'],sourceRefs:[] },
  { id:'person-hoelun',slug:'hoelun',title:'Hö’elün',profileType:'biography',role:'Historical figure in Temüjin’s family context',eraId:'before-chinggis',status:'researched',summary:'Hö’elün belongs to Temüjin’s family and early household context, but the current project lacks sources for a detailed biography.',relatedEntityIds:['person-temujin-chinggis-khan'],sourceRefs:[] },
  { id:'person-yesugei',slug:'yesugei',title:'Yesügei',profileType:'biography',role:'Historical figure in Temüjin’s family and political context',eraId:'before-chinggis',status:'researched',summary:'Yesügei belongs to Temüjin’s inherited family and political context. Detailed narrative episodes remain omitted without a verified source record.',relatedEntityIds:['person-temujin-chinggis-khan'],sourceRefs:[] },
  { id:'person-jamukha',slug:'jamukha',title:'Jamukha',profileType:'biography',role:'Independent political leader',period:'late 12th–early 13th centuries CE',eraId:'before-chinggis',status:'researched',summary:'Jamukha was an independent political actor in competing steppe coalitions. His changing relationship with Temüjin should not be reduced to a villain narrative.',relatedEntityIds:['event-jamukha-gur-khan-1201'],sourceRefs:[] },
  { id:'person-toghrul-ong-khan',slug:'toghrul-ong-khan',title:'Toghrul / Ong Khan',profileType:'biography',role:'Kereit ruler',period:'late 12th century–1203 CE',eraId:'before-chinggis',status:'researched',summary:'Toghrul was a major Kereit ruler with political agency beyond his changing relationship with Temüjin.',relatedEntityIds:['polity-kereit','event-kereit-defeat-1203'],sourceRefs:[] },
